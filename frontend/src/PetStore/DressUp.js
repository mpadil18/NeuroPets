...
function DressUp(props) {
    ...
    */
    ...
    const accessoriesByGearType = [["Blue Cap", "Orange Cap", "Red Cap", "Cowboy Hat",
                                    "Blue Party Hat", "Green Party Hat", "Pink Party Hat"],
    ...
    const changeStoreViewFrwd = () => {
        ...
        setDisplayedPetsRange([displayedPetsRange[0] + 5,
                               displayedPetsRange[1] + 5]);
    ...
    }, [selectedPet, displayedPetsRange,
        props.popupDisplay, props.selectedAccessory])
   ...
   <div className="Popup">
        ...
        <div className="InputBubble">
            ...
            {displayNextPopup ?
                ...
                <p className="BubbleHeader">Who to dress up in the<br/>
                ...
                <div className="gridContents">
                    ...
                    {(petArray.length > 0) ?
                        ...
                        ((petArray.reverse()).slice(displayedPetsRange[0], 
                            ...
                            {index + displayedPetsRange[0] === (0) ? 
                            
                                <img className="activeIcon" src={ActiveIcon} alt="active pet" /> 
                                :
                                null}

                            <p className="daysOld">{pet.progressCounter}/60d</p></div>)) 
                            : 
                            null
